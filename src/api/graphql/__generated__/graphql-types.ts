...
export type Insert_User_CarsMutation = { __typename?: 'mutation_root', insert_user_cars?: { __typename?: 'user_cars_mutation_response', returning: Array<{ __typename?: 'user_cars', car_id: number, user_id: number }> } | null };
...
export type Delete_User_CarsMutation = { __typename?: 'mutation_root', delete_user_cars?: { __typename?: 'user_cars_mutation_response', returning: Array<{ __typename?: 'user_cars', car_id: number, user_id: number }> } | null };
...
export const Insert_User_CarsDocument = gql`
  ...
  insert_user_cars(objects: $objects) {
    ...
    `;
export type Insert_User_CarsMutationFn = Apollo.MutationFunction<Insert_User_CarsMutation, Insert_User_CarsMutationVariables>;
 ...
 * });
 */
export function useInsert_User_CarsMutation(baseOptions?: Apollo.MutationHookOptions<Insert_User_CarsMutation, Insert_User_CarsMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<Insert_User_CarsMutation, Insert_User_CarsMutationVariables>(Insert_User_CarsDocument, options);
      }
export type Insert_User_CarsMutationHookResult = ReturnType<typeof useInsert_User_CarsMutation>;
export type Insert_User_CarsMutationResult = Apollo.MutationResult<Insert_User_CarsMutation>;
export type Insert_User_CarsMutationOptions = Apollo.BaseMutationOptions<Insert_User_CarsMutation, Insert_User_CarsMutationVariables>;
